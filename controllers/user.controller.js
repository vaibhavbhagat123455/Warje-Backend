...
async function sendOTP(req, res) {
  try {
    ...
    const subjectText = purpose === "signup"
      ? "Your Verification Code for Signup" // Slightly better subject line
    ...
    const mailOptions = {
      ...
      text: purpose === "signup"
        ? `Your verification OTP for signup is ${otp}. It is valid for 5 minutes. DO NOT SHARE THIS CODE.`
        : `Your OTP for login is ${otp}. It is valid for 5 minutes. DO NOT SHARE THIS CODE.`,
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 500px; margin: auto; padding: 20px; border-radius: 8px; background-color: #f9f9f9; border: 1px solid #ddd;">
            ...
            <div style="text-align: center; background-color: #030711; padding: 15px; border-radius: 8px 8px 0 0;">
                <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Maharashtra_Police_Insignia_India%5B1%5D-1JIZ4S6NTIdYu8aBpAKvqXl1zXn1VJ.png" alt="EventHorizon Logo" style="max-width: 80px;">
            ...
            <div style="background-color: #ffffff; padding: 20px; border-radius: 0 0 8px 8px; text-align: center;">
                <p style="font-size: 16px;">Dear <strong>${user.userName || 'User'}</strong>,</p>
